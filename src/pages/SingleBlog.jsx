...
const SingleBlog = () => {
    ...
    const [blogdelete,setdeleteBlog]=useState('false');

    const fetchSingleBlog =()=>{
        const response =axios.get("http:localhost://3000/blog"+id)
    ...
    //     const response =await axios.delete("localhost://3000/blog"+id)
